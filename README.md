...
Подобрал и установил программное обеспечение для настройки инфраструктуры проекта.
Настроил, запустил проект и обеспечил его безопасное использование.
Настроил мониторинг, чтобы знать текущее состояние проекта и быстро реагировать на неполадки.
## Технологии
- Python
- node.js
- frontend: React
